...
samples <- RunHarmony(samples, group.by.vars = "sample.id", dims.use = 1:20)

ElbowPlot(samples, reduction = "pca", ndims=60)
ElbowPlot(samples, reduction = "harmony", ndims=60)

# clustering
samples <- FindNeighbors(samples, reduction = "harmony", dims = 1:20, graph.name = "harmony_snn")
samples <- FindClusters(samples, resolution = 0.7, graph.name = "harmony_snn")
...
samples <- RunUMAP(samples, reduction = "harmony", dims = 1:20)
# samples <- RunUMAP(samples, 
#                    graph = "harmony_snn",
...
# split by sample id
DimPlot(samples, reduction = "umap", split.by = "sample.id")
...
new.cluster.ids <- c("cTEC","transit-amplifying","mTEC I","mTEC II","post-Aire",
                     "ionocyte","aaTEC","tuft","muscle","neuro","neuroendocrine",
                     "transitioning","COL4A6-positive TEC","CCL21-positive TEC",
                     "nurse","ciliated","CFC1-positive cTEC")
...
genes <- c("TBATA",
           ...
           "TOP2A",
           "CENPF")
FeaturePlot(samples, reduction = "umap", features = genes)
FeaturePlot(samples, reduction = "umap", features = "CIITA", label = TRUE, order = TRUE)
FeaturePlot(samples, reduction = "umap", features = "CD74", label = TRUE, order = TRUE)
FeaturePlot(samples, reduction = "umap", features = "HLA-DMA", label = TRUE, order = TRUE)

# cTEC
FeaturePlot(samples, reduction = "umap", features = "TBATA", label = TRUE, order = TRUE)
FeaturePlot(samples, reduction = "umap", features = "PRSS16", label = TRUE, order = TRUE)
# Transit-amplifying
FeaturePlot(samples, reduction = "umap", features = "MKI67", label = TRUE, order = TRUE)
FeaturePlot(samples, reduction = "umap", features = "TOP2A", label = TRUE, order = TRUE)
FeaturePlot(samples, reduction = "umap", features = "CENPF", label = TRUE, order = TRUE)
# mTEC I
FeaturePlot(samples, reduction = "umap", features = "CCL19", label = TRUE, order = TRUE)
FeaturePlot(samples, reduction = "umap", features = "KRT15", label = TRUE, order = TRUE)
FeaturePlot(samples, reduction = "umap", features = "KRT19", label = TRUE, order = TRUE)
FeaturePlot(samples, reduction = "umap", features = "FN1", label = TRUE, order = TRUE)
FeaturePlot(samples, reduction = "umap", features = "CLU", label = TRUE, order = TRUE)
# mTEC II
FeaturePlot(samples, reduction = "umap", features = "AIRE", label = TRUE, order = TRUE)
# Post-aire
FeaturePlot(samples, reduction = "umap", features = "SPINK5", label = TRUE, order = TRUE)
# Ionocyte
FeaturePlot(samples, reduction = "umap", features = "CFTR", label = TRUE, order = TRUE)
FeaturePlot(samples, reduction = "umap", features = "CDH12", label = TRUE, order = TRUE)
# aaTEC
FeaturePlot(samples, reduction = "umap", features = "VIM", label = TRUE, order = TRUE)
FeaturePlot(samples, reduction = "umap", features = "IGFBP7", label = TRUE, order = TRUE)
FeaturePlot(samples, reduction = "umap", features = "SPARC", label = TRUE, order = TRUE)
FeaturePlot(samples, reduction = "umap", features = "SPARCL1", label = TRUE, order = TRUE)
FeaturePlot(samples, reduction = "umap", features = "COL1A1", label = TRUE, order = TRUE)
# Tuft
FeaturePlot(samples, reduction = "umap", features = "POU2F3", label = TRUE, order = TRUE)
# Muscle
FeaturePlot(samples, reduction = "umap", features = "MYOG", label = TRUE, order = TRUE)
FeaturePlot(samples, reduction = "umap", features = "TTN", label = TRUE, order = TRUE)
FeaturePlot(samples, reduction = "umap", features = "MYH3", label = TRUE, order = TRUE)
# Neuroendocrine
FeaturePlot(samples, reduction = "umap", features = "HES6", label = TRUE, order = TRUE)
FeaturePlot(samples, reduction = "umap", features = "NEUROD1", label = TRUE, order = TRUE)
# Neuro
FeaturePlot(samples, reduction = "umap", features = "ATOH1", label = TRUE, order = TRUE)
FeaturePlot(samples, reduction = "umap", features = "USH2A", label = TRUE, order = TRUE)
# Transitioning
FeaturePlot(samples, reduction = "umap", features = "TESC", label = TRUE, order = TRUE)
FeaturePlot(samples, reduction = "umap", features = "CLDN3", label = TRUE, order = TRUE)
FeaturePlot(samples, reduction = "umap", features = "RGS17", label = TRUE, order = TRUE)
# COL4A6-positive TEC
FeaturePlot(samples, reduction = "umap", features = "COL4A6", label = TRUE, order = TRUE)
FeaturePlot(samples, reduction = "umap", features = "COL4A5", label = TRUE, order = TRUE)
FeaturePlot(samples, reduction = "umap", features = "COL8A1", label = TRUE, order = TRUE)
# CCL21-positive TEC
FeaturePlot(samples, reduction = "umap", features = "CCL21", label = TRUE, order = TRUE)
# Nurse
FeaturePlot(samples, reduction = "umap", features = "TBATA", label = TRUE, order = TRUE)
FeaturePlot(samples, reduction = "umap", features = "PRSS16", label = TRUE, order = TRUE)
FeaturePlot(samples, reduction = "umap", features = "CD3E", label = TRUE, order = TRUE)
FeaturePlot(samples, reduction = "umap", features = "PTPRC", label = TRUE, order = TRUE)
# Ciliated
FeaturePlot(samples, reduction = "umap", features = "FOXJ1", label = TRUE, order = TRUE)
# CFC1-positive cTECs
FeaturePlot(samples, reduction = "umap", features = "TBATA", label = TRUE, order = TRUE)
FeaturePlot(samples, reduction = "umap", features = "PRSS16", label = TRUE, order = TRUE)
FeaturePlot(samples, reduction = "umap", features = "CFC1", label = TRUE, order = TRUE)
FeaturePlot(samples, reduction = "umap", features = "TP53AIP1", label = TRUE, order = TRUE)
FeaturePlot(samples, reduction = "umap", features = "UBD", label = TRUE, order = TRUE)  # need to double check
