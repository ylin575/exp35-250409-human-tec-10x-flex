...
#DimHeatmap(samples, dims = 1:18, cells = 6, balanced = TRUE)
ElbowPlot(samples, ndims = 60)


# run harmony integration
samples_int <- RunHarmony(samples, group.by.vars = "sample.id", dims.use = 1:18)
# After preprocessing, we integrate layers with added parameters specific to Harmony:
samples_int <- IntegrateLayers(object = samples, method = HarmonyIntegration, 
                           orig.reduction = "pca",
                           new.reduction = 'harmony', 
                           verbose = TRUE)


ElbowPlot(samples_int, reduction = "pca", ndims=60)
ElbowPlot(samples_int, reduction = "harmony", ndims=60)

# clustering
samples_int <- FindNeighbors(samples_int, reduction = "harmony", dims = 1:18)
samples_int <- FindClusters(samples_int, resolution = 0.5)


# need to test various resolution settings
# samples_res_0_5 <- FindClusters(samples, resolution = 0.5, 
#                                 cluster.name = "0_5_res_clusters", graph.name = "harmony_snn")
...
samples_int <- RunUMAP(samples_int, reduction = "harmony", dims = 1:18)
# samples2 <- RunUMAP(samples,
#                    graph = "harmony_snn",
...
DimPlot(samples_int, 
        reduction = "umap",
        label = TRUE, 
        cells.highlight = WhichCells(samples_int, idents = 23))
DimPlot(samples_int, 
        reduction = "umap",
        label = TRUE, 
        cells.highlight = WhichCells(samples_int, idents = 7),
        split.by = "sample.id")
...
VlnPlot(samples_int, features = c("TBATA","PRSS16"))
FeaturePlot(samples_int, reduction = "umap", features = "CIITA", label = TRUE, order = TRUE)
FeaturePlot(samples_int, reduction = "umap", features = "CD74", label = TRUE, order = TRUE)
FeaturePlot(samples_int, reduction = "umap", features = "HLA-DMA", label = TRUE, order = TRUE)

# cTEC
FeaturePlot(samples_int, reduction = "umap", features = "TBATA", label = TRUE, order = TRUE)
FeaturePlot(samples_int, reduction = "umap", features = "PRSS16", label = TRUE, order = TRUE)
# Transit-amplifying
FeaturePlot(samples_int, reduction = "umap", features = "MKI67", label = TRUE, order = TRUE)
FeaturePlot(samples_int, reduction = "umap", features = "TOP2A", label = TRUE, order = TRUE)
FeaturePlot(samples_int, reduction = "umap", features = "CENPF", label = TRUE, order = TRUE)
# mTEC I
FeaturePlot(samples_int, reduction = "umap", features = "CCL19", label = TRUE, order = TRUE)
FeaturePlot(samples_int, reduction = "umap", features = "KRT15", label = TRUE, order = TRUE)
FeaturePlot(samples_int, reduction = "umap", features = "KRT19", label = TRUE, order = TRUE)
FeaturePlot(samples_int, reduction = "umap", features = "FN1", label = TRUE, order = TRUE)
FeaturePlot(samples_int, reduction = "umap", features = "CLU", label = TRUE, order = TRUE)
# mTEC II
FeaturePlot(samples_int, reduction = "umap", features = "AIRE", label = TRUE, order = TRUE)
# Post-aire
FeaturePlot(samples_int, reduction = "umap", features = "SPINK5", label = TRUE, order = TRUE)
# Ionocyte
FeaturePlot(samples_int, reduction = "umap", features = "CFTR", label = TRUE, order = TRUE)
FeaturePlot(samples_int, reduction = "umap", features = "CDH12", label = TRUE, order = TRUE)
# aaTEC
FeaturePlot(samples_int, reduction = "umap", features = "VIM", label = TRUE, order = TRUE)
FeaturePlot(samples_int, reduction = "umap", features = "IGFBP7", label = TRUE, order = TRUE)
FeaturePlot(samples_int, reduction = "umap", features = "SPARC", label = TRUE, order = TRUE)
FeaturePlot(samples_int, reduction = "umap", features = "SPARCL1", label = TRUE, order = TRUE)
FeaturePlot(samples_int, reduction = "umap", features = "COL1A1", label = TRUE, order = TRUE)
# Tuft
FeaturePlot(samples_int, reduction = "umap", features = "POU2F3", label = TRUE, order = TRUE)
# Muscle
FeaturePlot(samples_int, reduction = "umap", features = "MYOG", label = TRUE, order = TRUE)
FeaturePlot(samples_int, reduction = "umap", features = "TTN", label = TRUE, order = TRUE)
FeaturePlot(samples_int, reduction = "umap", features = "MYH3", label = TRUE, order = TRUE)
# Neuroendocrine
FeaturePlot(samples_int, reduction = "umap", features = "HES6", label = TRUE, order = TRUE)
FeaturePlot(samples_int, reduction = "umap", features = "NEUROD1", label = TRUE, order = TRUE)
# Neuro
FeaturePlot(samples_int, reduction = "umap", features = "ATOH1", label = TRUE, order = TRUE)
FeaturePlot(samples_int, reduction = "umap", features = "USH2A", label = TRUE, order = TRUE)
# Transitioning
FeaturePlot(samples_int, reduction = "umap", features = "TESC", label = TRUE, order = TRUE)
FeaturePlot(samples_int, reduction = "umap", features = "CLDN3", label = TRUE, order = TRUE)
FeaturePlot(samples_int, reduction = "umap", features = "RGS17", label = TRUE, order = TRUE)
# COL4A6-positive TEC
FeaturePlot(samples_int, reduction = "umap", features = "COL4A6", label = TRUE, order = TRUE)
FeaturePlot(samples_int, reduction = "umap", features = "COL4A5", label = TRUE, order = TRUE)
FeaturePlot(samples_int, reduction = "umap", features = "COL8A1", label = TRUE, order = TRUE)
# CCL21-positive TEC
FeaturePlot(samples_int, reduction = "umap", features = "CCL21", label = TRUE, order = TRUE)
# Nurse
FeaturePlot(samples_int, reduction = "umap", features = "TBATA", label = TRUE, order = TRUE)
FeaturePlot(samples_int, reduction = "umap", features = "PRSS16", label = TRUE, order = TRUE)
FeaturePlot(samples_int, reduction = "umap", features = "CD3E", label = TRUE, order = TRUE)
FeaturePlot(samples_int, reduction = "umap", features = "PTPRC", label = TRUE, order = TRUE)
# Ciliated
FeaturePlot(samples_int, reduction = "umap", features = "FOXJ1", label = TRUE, order = TRUE)
# CFC1-positive cTECs
FeaturePlot(samples_int, reduction = "umap", features = "TBATA", label = TRUE, order = TRUE)
FeaturePlot(samples_int, reduction = "umap", features = "PRSS16", label = TRUE, order = TRUE)
FeaturePlot(samples_int, reduction = "umap", features = "CFC1", label = TRUE, order = TRUE)
FeaturePlot(samples_int, reduction = "umap", features = "TP53AIP1", label = TRUE, order = TRUE)
FeaturePlot(samples_int, reduction = "umap", features = "UBD", label = TRUE, order = TRUE)  # need to double check

FeaturePlot(samples_int, reduction = "umap", features = "AIRE", split.by = "sample.id")
FeaturePlot(samples_int, reduction = "umap", features = "PRSS16", split.by = "sample.id")
FeaturePlot(samples_int, reduction = "umap", features = "PSMB11", split.by = "sample.id")
FeaturePlot(samples_int, reduction = "umap", features = "LY75", split.by = "sample.id")
FeaturePlot(samples_int, reduction = "umap", features = "COL4A6", split.by = "sample.id")
FeaturePlot(samples_int, reduction = "umap", features = "ITGA6", split.by = "sample.id")
FeaturePlot(samples_int, reduction = "umap", features = "THY1", split.by = "sample.id")
FeaturePlot(samples_int, reduction = "umap", features = "BCAM", split.by = "sample.id")
FeaturePlot(samples_int, reduction = "umap", features = "CLEC2L", split.by = "sample.id")
FeaturePlot(samples_int, reduction = "umap", features = "CIITA", split.by = "sample.id")


# 260304 annotate cells, dimensions used = 20, cluster resolution = 0.9
