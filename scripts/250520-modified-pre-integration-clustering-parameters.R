...
samples <- readRDS("data/rds-objects/250520-before-integration.rds")
...
saveRDS(sampleswi, file = "data/rds-objects/250520-after-integration.rds")
sampleswi <- readRDS(file = "data/rds-objects/250520-after-integration.rds")
...
sampleswi <- FindNeighbors(sampleswi, reduction = "integrated.cca", dims = 1:15)
sampleswi <- FindClusters(sampleswi, resolution = 0.5)

# run non-linear dimensional reduction
sampleswi <- RunUMAP(sampleswi, dims = 1:15, reduction = "integrated.cca")
