...
FeaturePlot_scCustom(samples, reduction = "umap", features = "MKI67", colors_use = viridis_light_high, order = order)
FeaturePlot_scCustom(samples, reduction = "umap", features = "TOP2A", colors_use = viridis_light_high, order = order)
FeaturePlot_scCustom(samples, reduction = "umap", features = "CENPF", colors_use = viridis_light_high, order = order)
FeaturePlot_scCustom(samples, reduction = "umap", features = "JUNB", colors_use = viridis_light_high, order = F)



# 270722 cluster 8 deep analysis
clust8 <- subset(samples, subset = seurat_clusters == 8)
